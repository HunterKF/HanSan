...
class WordMapperTest {
    ...
    private val mockPracticeTranslationData = listOf(
       PracticeTranslation("en", "to go"),
       PracticeTranslation("es", "ir"),
       PracticeTranslation("fr", "aller"),
       PracticeTranslation("de", "gehen"),
       PracticeTranslation("en", "to teach"),
       PracticeTranslation("es", "enseñar"),
       PracticeTranslation("fr", "enseigner"),
       PracticeTranslation("de", "Lehren")
    )
    @Test
    fun `Map word entity with translations`() {
        val mappedWords = mockWordData.map { it.toPracticeWordModel(mockPracticeTranslationData) }
        println(mappedWords)
    }
}